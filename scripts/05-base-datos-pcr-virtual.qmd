...
Biostrings::writeXStringSet(amplicons, fasta_file)
message("Amplicones (crudo) escrito en: ", fasta_file)
```
...
acc2org_cache_path <- file.path(metadata_location, sprintf("acc2org_cache_%s.tsv.gz", locus_name))
